...
public class CocoaTestVersion : NSObject {
    ...
    public lazy var confirmationButton : UIButton = {
        ...
        cbf.alpha = 0.0
        cbf.addTarget(self, action: #selector(self.handleAction(sender:)), for: .touchUpInside)
    ...
    public init(presentingViewController: UIViewController!, popupType : PopupType!) {
        super.init()
...
func registerFont(with fontName: String) {
    guard let url = Bundle(identifier: "org.cocoapods.CocoaTestVersion")!
